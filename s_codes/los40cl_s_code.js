...
var c6_comscore = escape("los40.cl");
...
function launchAjaxOMN(eVars,eVars_value,evento,listado_tags, autores){
    ...
    //add eVar19
    eVars= eVars + "|19";
    eVars_value= eVars_value + "|los40cl";
...
s.linkInternalFilters = "javascript:,los40.cl";
...
if (typeof(marcado_omniture_particular) == "undefined")
{
    ...
    {
        if (direccion.indexOf("//los40.cl/seccion") > -1 || direccion.indexOf("//los40.cl/programa") > -1) //portadilla de seccion virtual
        {
        ...
        {
            if (direccion.indexOf("//los40.cl/especiales/") > -1 ) //especiales
            {
                ...
                else
                {
                    ...
                    {
                        if (direccion.indexof("//los40.cl/especiales/") > -1 || direccion.indexof("//los40.cl/especiales/index.html") >-1 )
                        {
                            channel_omniture = "especiales";
                            seccion_omniture = "especiales";
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        prop3_omniture = "portada"
                        seccion_omniture = result_re3[1].replace(/los40\.cl/, "");
                        ...
                        else
                        {
                            ...
                            s.pageName = "los40cl/" + channel_omniture;
                        }
                    }
