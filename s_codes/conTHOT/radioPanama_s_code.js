...
s.linkInternalFilters="javascript:,radiopanama.com.pa"
...
if (arraySite[0] == "www"){	s.siteID="radiopanama.com.pa";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop14="panama";if(s.prop14)s.eVar14="D=c14";         								//País
        s.prop15="america";if(s.prop15)s.eVar15="D=c15";	       								//Zona (Región)
        s.prop17="web";if(s.prop17)s.eVar17="D=c17";        									//Soporte
        s.prop18="prisa";if(s.prop18)s.eVar18="D=c18";           								//Organización
        s.prop19="radiopanama";if(s.prop19)s.eVar19="D=c19";									//Producto
        s.prop20="radiopanama.com.pa";if(s.prop20)s.eVar20="D=c20";								//Server [Dominio/subdominio]
