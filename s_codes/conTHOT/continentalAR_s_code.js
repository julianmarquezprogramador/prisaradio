...
s.linkInternalFilters="javascript:,continental.com.ar"
...
if (arraySite[0] == "www"){	s.siteID="continental.com.ar";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop14="argentina";if(s.prop14)s.eVar14="D=c14";         								//Pais
        ...
        s.prop19="continental";if(s.prop19)s.eVar19="D=c19";									//Producto
        s.prop20="continental.com.ar";if(s.prop20)s.eVar20="D=c20";   							//Server [Dominio/subdominio]
        ...
        }else {s.prop31=tematica;if(s.prop31)s.eVar62="D=c31";}                    				//Tematica - se recoge en cada una de las paginas del site
