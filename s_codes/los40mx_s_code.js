...
var c6_comscore = escape("los40.com.mx");
...
function launchAjaxOMN(eVars,eVars_value,evento,listado_tags, autores){
    ...
    //s.account = 'prisacomurmxlos40';
    s=s_gi(s.account);
    //add eVar19
    eVars= eVars + "|19";
    eVars_value= eVars_value + "|los40mx";
...
s.linkInternalFilters = "javascript:,los40.com.mx";
...
if (typeof(marcado_omniture_particular) == "undefined")
{
    ...
    var dominio_omniture = "los40.com.mx";
    ...
    {
        if (direccion.indexOf("//los40.com.mx/seccion") > -1 || direccion.indexOf("//los40.com.mx/programa") > -1) //portadilla de seccion virtual
        {
        ...
        {
            if (direccion.indexOf("//los40.com.mx/especiales/") > -1 ) //especiales
            {
                ...
                else
                {
                    ...
                    {
                        if (direccion.indexof("//los40.com.mx/especiales/") > -1 || direccion.indexof("//los40.com.mx/especiales/index.html") >-1 )
                        {
                            channel_omniture = "especiales";
                            seccion_omniture = "especiales";
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        prop3_omniture = "portada"
                        seccion_omniture = result_re3[1].replace(/los40\.com\.mx/, "");
                        ...
                        else
                        {
                            ...
                            s.pageName = "los40mx/" + channel_omniture;
                        }
                    }
