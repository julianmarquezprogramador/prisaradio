...
var s_account="prisacomurclfmdos,prisacomglobal";
var s_accountF="prisacomurclfmdos"; //Defined suite functions
...
s.linkInternalFilters="javascript:,fmdos.cl"
...
if (arraySite[0] == "www"){	s.siteID="fmdos.cl";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop19="fmdos";if(s.prop19)s.eVar19="D=c19";											//Producto
        s.prop20="fmdos.cl";if(s.prop20)s.eVar20="D=c20";   									//Server [Dominio/subdominio]
