...
var s_account="prisacomurclrockpop,prisacomglobal";
var s_accountF="prisacomurclrockpop"; //Defined suite functions
...
s.linkInternalFilters="javascript:,rockandpop.cl"
...
if (arraySite[0] == "www"){	s.siteID="rockandpop.cl";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop19="rockandpop";if(s.prop19)s.eVar19="D=c19";										//Producto
        s.prop20="rockandpop.cl";if(s.prop20)s.eVar20="D=c20";   								//Server [Dominio/subdominio]
