...
var s_account="prisacomurclpudahuel,prisacomglobal";
var s_accountF="prisacomurclpudahuel"; //Defined suite functions
...
s.linkInternalFilters="javascript:,pudahuel.cl"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"

/* Form Analysis Plugin */
s.formList="gform_3" //Deberan incluirse solo los nombres de los formularios que se deseen seguir
...
/* TimeParting Config */
var date = new Date();
var anoActual=date.getFullYear(); //Recogemos el a̱o en el que estamos
...
if (arraySite[0] == "www"){	s.siteID="pudahuel.cl";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop19="pudahuel";if(s.prop19)s.eVar19="D=c19";										//Producto
        s.prop20="pudahuel.cl";if(s.prop20)s.eVar20="D=c20";			   						//Server [Dominio/subdominio]
