...
var s_account="prisacomurclimagina,prisacomglobal";
var s_accountF="prisacomurclimagina"; //Defined suite functions
...
s.linkInternalFilters="javascript:,radioimagina.cl"
...
if (arraySite[0] == "www"){	s.siteID="radioimagina.cl";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop19="imagina";if(s.prop19)s.eVar19="D=c19";										//Producto
        s.prop20="radioimagina.cl";if(s.prop20)s.eVar20="D=c20";   								//Server [Dominio/subdominio]
