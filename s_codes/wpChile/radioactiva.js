...
var s_account="prisacomurclradioactiva,prisacomglobal";
var s_accountF="prisacomurclradioactiva"; //Defined suite functions
...
s.linkInternalFilters="javascript:,radioactiva.cl"
...
if (arraySite[0] == "www"){	s.siteID="radioactiva.cl";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop19="radioactiva";if(s.prop19)s.eVar19="D=c19";									//Producto
        s.prop20="radioactiva.cl";if(s.prop20)s.eVar20="D=c20";   								//Server [Dominio/subdominio]
