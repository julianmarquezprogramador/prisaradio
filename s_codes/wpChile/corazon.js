...
var s_account="prisacomurclcorazon,prisacomglobal";
var s_accountF="prisacomurclcorazon"; //Defined suite functions
...
s.linkInternalFilters="javascript:,corazon.cl"
...
if (arraySite[0] == "www"){	s.siteID="corazon.cl";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop19="corazon";if(s.prop19)s.eVar19="D=c19";										//Producto
        s.prop20="corazon.cl";if(s.prop20)s.eVar20="D=c20";   									//Server [Dominio/subdominio]
