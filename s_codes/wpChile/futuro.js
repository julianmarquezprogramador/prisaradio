...
var s_account="prisacomurclfuturo,prisacomglobal";
var s_accountF="prisacomurclfuturo"; //Defined suite functions
...
s.linkInternalFilters="javascript:,futuro.cl"
...
if (arraySite[0] == "www"){	s.siteID="futuro.cl";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop19="futuro";if(s.prop19)s.eVar19="D=c19";											//Producto
        s.prop20="futuro.cl";if(s.prop20)s.eVar20="D=c20"; 				  						//Server [Dominio/subdominio]
