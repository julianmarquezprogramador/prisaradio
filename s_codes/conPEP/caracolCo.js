...
function launchAjaxOMN(eVars,eVars_value,evento,listado_tags, autores){
    ...
    switch(evento) {
        ...
        //Marcado comscore
        if (evento == "event11")
            comscoreImg.src = "http://b.scorecardresearch.com/p?c1=1&c2=8671776&c3=" + escape("caracol.com.co Sites") + "&c4=" + escape("caracol.com.co") + "&c5=03&cv=2.0&cj=1&rnd=" + String(Math.random()).substr(2,9);
        else
        if (evento == "event13")
        {
...
s.linkInternalFilters = "javascript:,caracol.com.co";
...
//if(s.prop5)s.eVar10=s.prop5;
    if(s.prop4)s.eVar10=s.prop4;		//    Cambia en Caracol
...
if (typeof(marcado_omniture_particular) == "undefined")
{
    ...
    var dominio_omniture = "caracol.com.co";
    ...
    var prop11_especial = "";
    var prop13_omniture = "radiocaracol";
    ...
    {
        if (direccion.indexOf("//caracol.com.co/seccion") >-1 || direccion.indexOf("//caracol.com.co/programa") > -1 || direccion.indexOf("//caracol.com.co/emisora") > -1) //portadilla de seccion virtual
        {
        ...
        {
            if (direccion.indexOf("//caracol.com.co/especiales/") > -1 ) //especiales
            {
            ...
            else
            {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    switch (direccion)
                                    {
                                        case "http://caracol.com.co/radio/programas/home_programas.html":
                                        case "https://caracol.com.co/radio/programas/home_programas.html":
                                        case "http://caracol.com.co/radio/programas/":
                                        case "https://caracol.com.co/radio/programas/":
                                        ...
                                        case "http://caracol.com.co/radio/emisoras/home_emisoras.html":
                                        case "https://caracol.com.co/radio/emisoras/home_emisoras.html":
                                        case "http://caracol.com.co/radio/emisoras/":
                                        case "https://caracol.com.co/radio/emisoras/":
                                            channel_omniture = "emisora";
                                            subseccion_omniture = "";
                                            prop3_omniture = "portada";
                                            prop4_tipo_pagina = "portadilla";
                                        ...
                                        case "http://caracol.com.co/radio/ultimas_noticias/":
                                        case "https://caracol.com.co/radio/ultimas_noticias/":
                ...
                else
                {
                    ...
                    {
                        prop3_omniture = "portada"
                        channel_omniture = result_re3[1].replace(/caracol\.com.co/, "");
                        ...
                        else
                        {
                            ...
                            s.pageName = "caracol.com.co/" + channel_omniture;
                        }
                    }
    ...
    switch (channel_omniture)
    {
        case "emisora":
            if (circuitos_regionales[subseccion_omniture])
            {
                ...
                prop1_omniture = prop13_omniture + ":" + subseccion_omniture;
            }
            else if (subseccion_virtual)
            {
                prop13_omniture = subseccion_omniture;
                prop1_omniture = prop13_omniture + ":" + subseccion_virtual;
            }
            else
                prop13_omniture = subseccion_omniture; //nombre del programa o emisora
            break;
        ...
        case "programa":
            ...
            else if(typeof(ls_subseccionMarca) != "undefined"){
                //ls_subseccionMarca se obtiene en activacion_videos_y_publicidad según los lh_niveles_noticia y ante la inexistencia de la subseccion
                prop13_omniture = ls_subseccionMarca;
            } else
                prop13_omniture = subseccion_omniture;
        ...
        default:
            prop13_omniture = "caracol";
            if (channel_omniture == "radio" && subseccion_omniture != "")
                channel_omniture = subseccion_omniture;
            break;
    }

    if(typeof(tagagr_norm0) != "undefined"){
        //tagagr_norm0 se obtiene en activacion_videos_y_publicidad tomando el primer tag agrupado al que se encuentre relacionada la noticia.
        if (channel_omniture==subseccion_omniture)
            prop1_omniture = channel_omniture + ">" + tagagr_norm0;
        else
            prop1_omniture = channel_omniture + ">" + subseccion_omniture + ":" + tagagr_norm0;
    }

    if (prop13_omniture == "caracol_fm")
        prop13_omniture = "caracol";
