...
var c6_comscore = escape("los40.com.co");
...
/*if (typeof(s_account) == "undefined" )
	var s_account = "prisacomurcolos40,prisacomglobal";
	var s_accountF = "prisacomurcolos40";
*/

//Permitimos modificar la suit definiendo antes la variable s_account
if (typeof(s_account) == "undefined" ) {
    if(/los40.com.co/.test(location.hostname)){                       // Producción
        var s_account = 'prisacomurcolos40,prisacomglobal';
        var s_accountF = 'prisacomurcolos40';
    } else {
...
function launchAjaxOMN(eVars,eVars_value,evento,listado_tags, autores){
    ...
    //add eVar19
    eVars= eVars + "|19";
    eVars_value= eVars_value + "|los40co";
    ...
    switch(evento) {
        case "event11": case "event12": case "event13": case "event14":
            ...
            s.account = 'prisacomurcolos40,prisacomglobal';
...
s.linkInternalFilters = "javascript:,los40.com.co";
...
if (typeof(marcado_omniture_particular) == "undefined")
{
    ...
    var dominio_omniture = "los40.com.co";
    ...
    {
        if (direccion.indexOf("//los40.com.co/seccion") > -1 || direccion.indexOf("//los40.com.co/programa") > -1) //portadilla de seccion virtual
        {
        ...
        {
            if (direccion.indexOf("//los40.com.co/especiales/") > -1 ) //especiales
            {
                ...
                else
                {
                    ...
                    {
                        if (direccion.indexof("//los40.com.co/especiales/") > -1 || direccion.indexof("//los40.com.co/especiales/index.html") >-1 )
                        {
                            channel_omniture = "especiales";
                            seccion_omniture = "especiales";
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        prop3_omniture = "portada"
                        seccion_omniture = result_re3[1].replace(/los40\.com\.co/, "");
                        ...
                        else
                        {
                            ...
                            s.pageName = "los40co/" + channel_omniture;
                        }
                    }
