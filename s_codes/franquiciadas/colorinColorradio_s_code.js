...
s.linkInternalFilters="javascript:,colorincolorradio.com.co"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"

/* Form Analysis Plugin */
s.formList="dataform,loginForm" //Deberan incluirse solo los nombres de los formularios que se deseen seguir
...
if (arraySite[0] == "www"){	s.siteID="colorincolorradio.com.co";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop14="colombia";if(s.prop14)s.eVar14="D=c14";         								//Pais
        ...
        s.prop19="colorincolorradio";if(s.prop19)s.eVar19="D=c19";								//Producto
        s.prop20="colorincolorradio.com.co";if(s.prop20)s.eVar20="D=c20";   					//Server [Dominio/subdominio]
        ...
        if((typeof(seccion)!='undefined')&&(typeof(subseccion)!='undefined')&&(typeof(subsubseccion)!='undefined')){
            ...
            */
            ...
            s.hier1=s.hier1+">"+document.title; //Nos quedara construido como "Dominio>Channel>Subseccion>Tema>Subtema>PageTitle"
