...
s.linkInternalFilters="javascript:,los40.py"
...
if (arraySite[0] == "www"){	s.siteID="los40.py";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop14="paraguay";if(s.prop14)s.eVar14="D=c14";         								//Pais
        ...
        s.prop19="los40py";if(s.prop19)s.eVar19="D=c19";								//Producto
        s.prop20="los40.py";if(s.prop20)s.eVar20="D=c20";  				 						//Server [Dominio/subdominio]
