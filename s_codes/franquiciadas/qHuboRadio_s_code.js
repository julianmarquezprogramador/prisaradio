...
/* Formularios */
function FormMeasurementOMN(type,form_name,element_error){
    s.sendFormEvent(type, s.pageName, form_name, element_error);
}
/* Fin Formularios */
...
//Internal Campaigns Trackings
    ...
    */
    ...
    /* Copy subseccion, subsubseccion, tipo, agregador, organizacion, medio, dominio, subdominio term to eVar */

    s.eVar3="D=pageName"  			// Copy pageName to eVar
