...
s.linkInternalFilters="javascript:,los40.do"
...
if (arraySite[0] == "www"){	s.siteID="los40.do";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        s.prop14="republica dominicana";if(s.prop14)s.eVar14="D=c14";         					//Pais
        ...
        s.prop19="los40do";if(s.prop19)s.eVar19="D=c19";								//Producto
        s.prop20="los40.do";if(s.prop20)s.eVar20="D=c20";  				 						//Server [Dominio/subdominio]
