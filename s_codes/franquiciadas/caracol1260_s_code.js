...
var useSSL = location.protocol=='https' ? true : false;
...
s.linkInternalFilters="javascript:,caracol1260.com/uswradiofl"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"

/* Form Analysis Plugin */
s.formList="dataform,loginForm" //Deberán incluirse sólo los nombres de los formularios que se deseen seguir
...
if (arraySite[0] == "www"){	s.siteID="caracol1260.com/uswradiofl";}
else{s.siteID=site;}
s.defaultPage="";
s.queryVarsList="";
s.pathExcludeDelim=";";
...
function s_doPlugins(s) {
    ...
    if(s.pageType!='errorPage'){
        ...
        if (typeof(tipo_contenido)=='undefined'){
            tipo_contenido='';
        }else {s.prop3=tipo_contenido;if(s.prop3)s.eVar7="D=c3";}								//TipoContenido - se recoge en cada una de las páginas del site
        s.prop14="usa";if(s.prop14)s.eVar14="D=c14";         									//País
        s.prop15="us";if(s.prop15)s.eVar15="D=c15";	       										//Zona (Región)
        s.prop17="web";if(s.prop17)s.eVar17="D=c17";        									//Soporte
        s.prop18="prisa";if(s.prop18)s.eVar18="D=c18";           								//Organización
        s.prop19="caracol1260";if(s.prop19)s.eVar19="D=c19";										//Producto
        s.prop20="caracol1260.com/uswradiofl";if(s.prop20)s.eVar20="D=c20";						//Server [Dominio/subdominio]
        ...
        }else {s.prop31=tematica;if(s.prop31)s.eVar62="D=c31";}                    				//Tematica - se recoge en cada una de las páginas del site
        if (typeof(userId)=='undefined'){
            userId='';
        }else {s.prop34=userId;if(s.prop34)s.eVar43="D=c34";}                              		//ID Usuario Registrado - se recoge en cada una de las páginas del site
        /****************************************************************/

        if((typeof(seccion)!='undefined')&&(typeof(subseccion)!='undefined')&&(typeof(subsubseccion)!='undefined')){
            /************** VARIABLES DE SECCIONES Y JERARQUÍA ***************/
            /*
            secciones
            */
            if(typeof(seccion)!='undefined' && seccion != ''){
                //seccion - Es una variable global definida en cada una de las páginas
                s.channel=seccion;			//Nueva definición del channel "seccion"
                s.pageName=s.channel;
            }
            if(typeof(s.channel)!='undefined' && typeof(subseccion)!='undefined' && subseccion != ''){
                //subseccion - Es una variable global definida en cada una de las páginas
                s.pageName+=":"+subseccion;
                s.prop1=s.channel+">"+subseccion;		//Nueva definición de subsección: "seccion>subseccion"
                s.eVar1="D=c1";
            }
            if((typeof(s.prop1)!='undefined')&&(typeof(subsubseccion)!='undefined')&&(subsubseccion != '')){
                //subsubseccion - Es una variable global definida en cada una de las páginas
                s.pageName+=":"+subsubseccion;
                s.prop2=s.prop1+">"+subsubseccion;		//Nueva definición de sub-subsección: "seccion>subseccion>subsubseccion"
                s.eVar6="D=c2";
            }
            if((typeof(s.prop2)!='undefined')&&(typeof(tema)!='undefined')&&(tema != '')){
                //Tema - Es una variable global definida en cada una de las páginas
                s.pageName+=":"+tema;
                s.prop4=s.prop2+">"+tema;				//Nueva definición de tema: "seccion>subseccion>subsubseccion>tema"
                s.eVar10="D=c4";
            }
            if((typeof(s.prop4)!='undefined')&&(typeof(subtema)!='undefined')&&(subtema != '')){
                //Subtema - Es una variable global definida en cada una de las páginas
                s.pageName+=":"+subtema;
                s.prop11=s.prop4+">"+subtema;			//Nueva definición de subtema: "seccion>subseccion>subsubseccion>tema>subtema"
                s.eVar11="D=c11";
            }
            if((typeof(s.prop11)!='undefined')&&(typeof(subtema1)!='undefined')&&(subtema1 != '')){
                //Subtema1 - Es una variable global definida en cada una de las páginas
                s.pageName+=":"+subtema1;
                s.prop12=s.prop11+">"+subtema1;			//Nueva definición de subtema: "seccion>subseccion>subsubseccion>tema>subtema>subtema1"
                s.eVar12="D=c12";
            }

            /*
            Jerarquías s.hier1 = Dominio>Channel>Subsección>Sub-subsección>Tema>Subtema>PageTitle
            */
            ...
            s.hier1=s.hier1+">"+document.title; //Nos quedará construido como "Dominio>Channel>Subsección>Tema>Subtema>PageTitle"
        ...
        /*Inicialización del plugin FormAnalysis*/
        s.setupFormAnalysis();
