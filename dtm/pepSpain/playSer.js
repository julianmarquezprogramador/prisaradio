...
if (typeof(page_type) == 'undefined') page_type='otros';
if (typeof(program) == 'undefined') program='';
if (typeof(content_type) == 'undefined') content_type='';
if (typeof(program_section)=='undefined') program_section='';
if (typeof(special_name) == 'undefined') special_name='';
...
if (typeof(primera_carga_marcado_satellite) == 'undefined') primera_carga_marcado_satellite='';
...
// External Campaign Tracking
    ...
    if(primera_carga_marcado_satellite==true)	s.abort = true;
...
// EW
    if(section=="widget"){
        ...
        if(/cadenaser.com/.test(parentDomain)){
            s.abort = true;
        }
    }
    ...
    s.prop15="españa";  																								// Zone (Region) : RADIO
    s.prop17='web';																											// Canal
    s.prop18="prisa";																										// Organization
    s.prop19="cadenaser";																								// Product
...
//s.prop31="informacion"; 																					// Temathic
    ...
    if(typeof arrayAmp !== 'undefined') {
        if (arrayAmp['amp'] == "true") {
            omn_cleanTitleAMP();
            var circuitos_regionales= omn_makeRegionalCircuit();
            //re-write some props for AMP
            var nombrePrograma_emisora="";
            s.prop3= "articulo";
            s.prop17="amp";
            ...
            if (result_re ) {
                ...
                s.channel = result_re[6];//va a tomar el nombre de la sección editorial "política, tribunales, internacional...bazar
                s.prop13 = "cadenaser";
                //Si es emisora o programa
                if ((s.prop2=="emisora")||(s.prop2=="programa")){
                    s.channel = result_re[2]; // va a tomar el string "emisora" o "programa"
                    nombrePrograma_emisora= result_re[6];
                    switch (s.channel){
                        case "emisora":
                            if (circuitos_regionales[nombrePrograma_emisora])
                            {
                                s.prop13 = nombrePrograma_emisora;
                                s.prop1 = nombrePrograma_emisora  + ":" +  circuitos_regionales[nombrePrograma_emisora];
                            }
                            else
                            {
                                s.prop13 = nombrePrograma_emisora; //nombre de la emisora
                            }
                        ...
                        case "programa":
                            ...
                            // {
                            //     s.prop13 = nombrePrograma_emisora;
                            //     s.prop1 = s.prop13 + ":" + subseccion_virtual;
                            // }
                            // else
                            s.prop13 = nombrePrograma_emisora;
...
// force all Adobe SiteCatalyst variables to Lower Case
    ...
    if(typeof arrayAmp !== 'undefined') {
        if((typeof(arrayAmp['amp'])!='undefined')&&(arrayAmp['amp'] == "true")){
            s.prop57= 'D="sin_adblock-"+user-agent';
            s.eVar57= 'D="sin_ADBLOCK-"+User-Agent';
        }
        else{
            s.prop57=adblock_enabled;
            s.eVar57=adblock_enabled;
        }
    }
    else{//cuando no es AMP
...
function omn_makeRegionalCircuit(){
    var arrayRC= {
...
var dtm_version= "dtm version 1.1.2";
if(typeof tucu !== 'undefined'){
    if(typeof tucu.dev !== 'undefined'){
        if(tucu.dev == true){
            ...
            console.log("feature: fixed bugs");
            console.log("////////////////////////////////////////////////////");
        }
        else{
            console.log(dtm_version);
