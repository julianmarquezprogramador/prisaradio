...
DTMR = function (hostname) {
//    var re = /^[a-z][a-z0-9+.-]*:\/\/([a-z0-9._~%!$&'()*+,;=-]+@)?([a-z0-9._~%-]+|\[[a-z0-9._~%!$&'()*+,;=:-]+)/ig;
//    var m = url.match(re);
//    this._hostn = m ? m[0] : "";
    this._hostn = hostname;
    Object.defineProperties(this, {
        ...
        _objProductos: {
            value: [
                ...
                {
                    re: "los40\.com\.pa\/?$",  // Panamá
                    c: "panama",
                    z: "america",
                    p: "los40pa"
                },
                {
                    re: "los40\.com\.ar\/?$",  // Argentina
                    c: "argentina",
                    z: "america",
                    p: "los40ar"
                },
                {
                    re: "los40\.com\.mx\/?$",  // Mexico
                    c: "mexico",
                    z: "america",
                    p: "los40mx"
                },
                {
                    re: "los40\.com\.co\/?$",  // Colombia
                    c: "colombia",
                    z: "america",
                    p: "los40co"
                },
                ...
                {
                    re: "los40\.co\.cr\/?$",  //Costa Rica
                    c: "costa rica",
                    z: "america",
                    p: "los40cr"
                },
                {
                    re: "los40\.do\/?$",  // Republica Dominicana
                    c: "republica dominicana",
                    z: "america",
                    p: "los40do"
                },
                {
                    re: "los40\.com\.py\/?$",  // Paraguay
                    c: "paraguay",
                    z: "america",
                    p: "los40py"
                },
                {
                    re: "los40\.com\.ec\/?$",  // Ecuador
                    c: "ecuador",
                    z: "america",
                    p: "los40ec"
                },
                {
                    re: "los40\.com\.gt\/?$",  // Guatemala
                    c: "guatemala",
                    z: "america",
                    p: "los40gt"
                }
        ...
        _objProducto: {
            get: function() {
                ...
                var output = this._objProductos.filter(function (x) {
                    var re = new RegExp(x.re);
                    return re.test(self._hostn);
                });
                return (typeof output[0] === 'undefined') ? def_val : output[0];
            },
            enumerable:false
        },
        country: {
            get: function () {
                return this._objProducto.c
            },
            enuerable: true
        },
        zone: {
            get: function () {
                return this._objProducto.z
            },
            enuerable: true
        },
        product: {
            get: function () {
                return this._objProducto.p
            },
            enuerable: true
        },
        version: {
            get: function () {
                return Array("version",this._v.prefix, this._v.version).join(this._v._sep);
            },
            enumerable: true
        },
        log: {
            value: function () {
                var cambios = [
                    ...
                    "feature: fixed previous version 2.1.3",
                    "////////////////////////////////////////////////////"
                ];
