...
function omn_asyncPV(){
    ...
    if(section=="widget"){
        ...
        if(/m80radio.com/.test(parentDomain)){
            s.abort = true;
        }
    }
    ...
    // s.channel=section;
    // s.pageName=s.channel;												// Manual formation s.PageName (Recommended Adobe Analytics)
...
if (section == 'player') adblock_enabled='';
...
var dtm_version= "dtm version 2.0.4";
if(typeof tucu !== 'undefined'){
    if(typeof tucu.dev !== 'undefined'){
        if(tucu.dev == true){
            console.log("/////////////////////DTM////////////////////////////");
            console.log(dtm_version);
            console.log("bugs: name pageName with legends ':direct'");
            console.log("solved: deleted legends ':direct'");
