...
function omn_asyncPV(){
    ...
    if(section=="widget"){
        ...
        if(/radiole.com/.test(parentDomain)){
            s.abort = true;
        }
    }
...
function omn_launchVendorConsents(vendor){
    window.__cmp("getVendorConsents", [vendor], function(results){
        ...
        var comscore_consent = results.vendorConsents[vendor] ? "1" : "0";
        _comscore.push({ c1: "2", c2: "8671776", cs_ucfr: comscore_consent});
        (function() {
...
if(typeof tucu !== 'undefined'){
    if(typeof tucu.dev !== 'undefined'){
        if(tucu.dev == true){
            ...
            console.log("feature: Add Krux into AMP");
