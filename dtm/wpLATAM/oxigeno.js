...
function omn_asyncPV(){
    ...
    if(section=="widget"){
        ...
        if(/.oxigeno.fm/.test(parentDomain)){
            s.abort = true;
        }
    }
...
// External Campaign Tracking
    ...
    if(s.prop73)s.eVar83="D=c73"												// Country (selected)
...
s.prop73=countryP;																									// Country (selected)
...
var dtm_version= "dtm version 1.0.7";
